...
Y = np.array([40, 50, 50, 70, 65, 65, 80]) #Yield
X1 = np.array([100, 200, 300, 400, 500, 600, 700]) #Fertilizer
X2 = np.array([10, 20, 10, 30, 20, 20, 30]) #Rainfall
...
print("\nYield Mean : Y = ",Y_mean)
print("Fertilizer Mean : X1 = ",X1_mean)
print("Rainfall Mean : X2 = ",X2_mean)
